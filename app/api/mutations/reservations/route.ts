...
import { createReservation, deleteReservation, updateReservation } from '@/app/actions/reservations'
...
export async function POST(request: Request) {
  try {
    ...
    let result: { success: true; data: unknown } | { success: false; error: string }
