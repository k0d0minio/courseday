    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-5xl grid-cols-1 gap-12 px-6 py-20 sm:py-28 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)]">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-muted-foreground text-base leading-relaxed">{t('body')}</p>
        </div>
        <div className="bg-background rounded-2xl border border-black/5 p-6 shadow-[0_24px_80px_-48px_rgba(20,60,35,0.35)] sm:p-8 dark:border-white/5">
          <DemoForm
            labels={{
              name: t('nameLabel'),
              email: t('emailLabel'),
