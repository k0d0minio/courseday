    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Shown in the header. Recommended: PNG or SVG, max 5 MB.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {logoUrl && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Used to show weather forecasts on the day view.</CardDescription>
        </CardHeader>
        <CardContent>
